...
using CTUScheduler.Presentation.Converters;
...
namespace CTUScheduler.Presentation.Presentation.Presentation.Controls
{
        ...
        private void ItemsTemplateDefinition()
        {
            Template = new FuncControlTemplate((control, scope) =>
            {
                ...
                var presenter = new ItemsPresenter()
                {
                    ...
                    [~ItemsPresenter.ItemsPanelProperty] = control[~ItemsPanelProperty],
                };
