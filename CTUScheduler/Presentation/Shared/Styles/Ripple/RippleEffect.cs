...
namespace CTUScheduler.Presentation.Shared.Styles.Ripple {
    public class RippleEffect : ContentControl {
        ...
        private void OnReleaseHandler(CompositionCustomVisual r) {
            ...
            }, CTUScheduler.Presentation.Shared.Styles.Ripple.Ripple.Duration, DispatcherPriority.Render);
        }
        ...
        private CompositionCustomVisual CreateRipple(double x, double y, bool center) {
            ...
            var handler = new RippleHandler(
                ...
                CTUScheduler.Presentation.Shared.Styles.Ripple.Ripple.Easing,
                CTUScheduler.Presentation.Shared.Styles.Ripple.Ripple.Duration,
