...
using ReactiveUI;
using Ursa.Controls;
using UrsaPosition = Ursa.Controls.HorizontalPosition; // Alias để tránh trùng tên
using UrsaVPosition = Ursa.Controls.VerticalPosition;
using DialogOptions =
    CTUScheduler.Presentation.Services.UserInteractionService.Abstractions.Models.Dialogs.DialogOptions;

namespace CTUScheduler.Presentation.Services.UserInteractionService.Infrastructure.Ursa.Dialogs;
